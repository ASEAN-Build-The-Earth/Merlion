...
class HelpCommand extends Command 
{
	...
	async messageRun(message, args) 
	{
        ...
        const helpEmbed = new MessageEmbed()
            .setColor("#ffc561")
            .setTitle(":earth_asia: **Sticky Rice Advaliable Commands**")
            .setThumbnail("https://asean.buildtheearth.asia/media/icons/aseanbte_logo.gif")
            .setFooter({text: "Build The Earth | Team ASEAN"});
        ...
        commands.forEach((element) => {
            if(element.fullCategory.includes(commands.categories[i])) {
                ...
                if(element.fullCategory[1] === undefined) {
                    ...
                    if(element.fullCategory[1] === "test") return; /* special skip for system/test category */
