...
module.exports = {
    ...
    execute(message, args) {
        const devtodo = new Discord.MessageEmbed()
            ...
            .addFields({ name: "Amenu ", value: " Like final ver least bugs" }, { name: "Bmenu", value: "Beta vers alot of bugs" }, { name: "Cmenu", value: "Dosnt Exist" }, { name: "TINmenu", value: "Grabs dog images and stuff (Dosnt exist yet)" }, )
